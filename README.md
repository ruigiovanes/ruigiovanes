...
I'm an experienced software developer with a focus on full-stack Web development. My technical skills include a wide range of technologies, such as C#/.NET, SQL (PostgreSQL, SQL Server), ORMs (Entity Framework, Dapper), JavaScript (Vanilla, Angular, jQuery), HTML/CSS, MVC, and Microsoft Razor. I'm also familiar with Python, AWS Lambda, and a bit of Selenium.
